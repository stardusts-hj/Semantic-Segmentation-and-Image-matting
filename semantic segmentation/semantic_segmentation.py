# -*- coding: utf-8 -*-
"""“semantic segmentation.ipynb”的副本
...
def find_people(seg_map):
  ...
  x = np.expand_dims(x,2).repeat(3,axis=2)   # expand the dimensions, seg_map (axis_x, axis_y, 1)  --->  (axis_x, axis_y, 3)
  x = x/(15*255)
  return x
...
def vis_segmentation(image, seg_map):
  ...
  seg_people = find_people(seg_map)
